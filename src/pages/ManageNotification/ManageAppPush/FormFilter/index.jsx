  ...
  return (
    ...
    >
      ...
      <Row gutter={20}>
        ...
        <Col xs={24} sm={12} md={12} lg={6} xl={6}>
          <Form.Item name="sourceSystem" label="Hệ thống">
            <Input placeholder="Nhập hệ thống" />
          </Form.Item>
        </Col>
        <Col xs={24} sm={12} md={12} lg={6} xl={6}>
          <Form.Item name="messageKey" label="Mã thông báo">
            <Input placeholder="Nhập mã thông báo" />
          </Form.Item>
        </Col>
        <Col xs={24} sm={12} md={12} lg={6} xl={6}>
          <Form.Item name="uploadedAt" label="Thời gian đăng">
            <RangePicker
              style={{ width: "100%" }}
