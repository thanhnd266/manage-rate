...
const SignUp = () => {
  return (
    <div className='rounded-sm h-screen flex justify-center items-center border border-stroke bg-white shadow-default'>
      <div className='flex flex-wrap items-center'>
        ...
        <div className='w-full border-stroke lg:w-1/2 lg:border-l-2'>
          <div className='w-full p-5 sm:p-12.5 xl:p-17.5'>
            <h2 className='mb-9 text-center text-2xl font-bold text-black sm:text-title-xl2'>
              Đăng ký
            </h2>
            ...
            <form>
              <div className='mb-4'>
                ...
                <div className='relative'>
                  <input
                    ...
                    className='w-full rounded-lg border border-stroke bg-transparent py-3 pl-4 pr-8 outline-none focus:border-main focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary'
                  />
              ...
              <div className='mb-4'>
                ...
                <div className='relative'>
                  <input
                    ...
                    className='w-full rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-main focus-visible:shadow-none'
                  />
              ...
              <div className='mb-5'>
                <input
                  type='submit'
                  value='Tạo tài khoản'
                  className='w-full cursor-pointer rounded-lg border border-main bg-[#36c05b] p-4 text-white transition hover:bg-opacity-90'
                />
              </div>
