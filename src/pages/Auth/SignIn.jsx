...
const SignIn = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response?.code === "0" || response.status_code) {
  ...
  return (
      <div className="login-page rounded-sm h-screen flex justify-center items-center border border-stroke bg-white shadow-default">
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-main focus-visible:shadow-none"
                      value={userName}
